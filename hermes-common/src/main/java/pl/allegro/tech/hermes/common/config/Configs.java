...
public enum Configs {
    ...
    KAFKA_CONSUMER_TIMEOUT_MS("kafka.consumer.timeout.ms", 30000),
    ...
    KAFKA_CONSUMER_FETCH_MIN_BYTES("kafka.consumer.fetch.min.bytes", 1024),
    KAFKA_CONSUMER_FETCH_MAX_WAIT_MS("kafka.consumer.fetch.max.wait.ms", 500),
    KAFKA_CONSUMER_MAX_PARTITION_FETCH_BYTES("kafka.consumer.max.partition.fetch.bytes", 1024 * 1024),
